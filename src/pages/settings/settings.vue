            ...
            <div class="modal-box">
                <div class="modal-content">
                    ...
                    <div v-else-if="modalMode === 'cookie'">
                        ...
                        <textarea class="cookie-input" v-model="cookieInput" placeholder="粘贴 Cookie 字符串 (SESSDATA=xxx; bili_jct=xxx; ...)" @input="onCookieInput" autofocus="true" softInputEnable="true" style="width: 100%; height: 80px;"></textarea>
                        <text class="cookie-tip">方式2: 电脑运行同步服务，输入电脑 IP 点击下方按钮自动获取</text>
                        <input class="cookie-input" v-model="computerIp" placeholder="电脑 IP (如 192.168.1.100)" @input="onCookieInput" autofocus="true" softInputEnable="true" style="width: 100%; height: 40px;"></input>
